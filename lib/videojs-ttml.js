/**
 * Frankly Inc - Steve Melendez
 * Based off videojs-ttml project @ https://github.com/SRGSSR/videojs-ttml
 */
(function(factory) {
    if (typeof define === 'function' && define['amd']) {
        define('franklyttml',['video.js'], function(videojs){ factory(window, document, videojs) });
    ...
    function FranklyTTMLParser() {
        this.domParser = new DOMParser();
    }

    FranklyTTMLParser.prototype = {
    ...
    var franklyTTML = function() {
        ...
        this.addRemoteTextTrack = function(options) {
            var parser = new FranklyTTMLParser();
            var src = options.src;
    ...
    videojs.plugin('franklyTTML', franklyTTML);
});
